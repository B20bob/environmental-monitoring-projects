Scripts in this folder are written in python3 and are intended to be run with raspberry pi in conjuction with AdafruitIO. You will need an active AdafruitIO account. Sources and guides are linked below.
